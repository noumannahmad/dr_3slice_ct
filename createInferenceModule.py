...
def main(argv):
    ...
    path_network = "../DR_BodyComposition_3CT/cross_validation/networks/SCAPIS_BC_traintest/"
    ...
    path_calibration = "../DR_BodyComposition_3CT/cross_validation/networks/SCAPIS_BC_traintest/calibration_factors.txt"
