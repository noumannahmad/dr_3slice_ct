...
def main(argv):
    ...
    output_path = "../networks/Scapis_traintest/"
    imageset_path = "../SCAPIS_8bit_CT_image/"

    if False:
        target_paths = ["../targets/SCAPIS_uint8_LiverArea_10fold/",
                        "../targets/SCAPIS_uint8_VAT_10fold/"]

    if True:
        target_paths = ["../targets/Scapis_uint8_traintest/"]
