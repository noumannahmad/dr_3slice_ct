...
def main(argv):
    ...
    imageset_path = "../DR_BodyComposition_3CT/SCAPIS_8bit_CT_image/"
    split_path = "../splits/SCAPIS_VAT_kfold/"

    #
    description = "VAT"
    field = "VAT_measuemrent"
    unit = "cm\u00b2"

    #
    output_path = f"../targets/Scapis_uint8_{description}_traintest/"
    field_path = f"../SCAPIS/abdomen_VAT.txt"
